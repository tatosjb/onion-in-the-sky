...
RSpec.describe 'AsyncClosestSatellites', type: :request do
  ...
  describe 'GET /index' do
    it 'enqueues the job to update the cache data' do
      expect(LoadDetailedStarlinkSatellitesAndOrbitsJob).to receive(:perform_async).with('0', '0', '10', nil)

      get async_closest_satellites_path, params: { latitude: 0, longitude: 0, number_of_satellites: 10 }
    end
    ...
    describe 'when there are no satellites' do
      ...
      it 'returns an empty array' do
        get async_closest_satellites_path
    ...
    describe 'when there are satellites' do
      it 'returns the closest satellites' do
        get async_closest_satellites_path, params: { latitude: '0', longitude: '0', number_of_satellites: '3' }
      ...
      it 'returns 10 satellites when ther number of satelites is nil' do
        get async_closest_satellites_path, params: { latitude: '6', longitude: '6' }
